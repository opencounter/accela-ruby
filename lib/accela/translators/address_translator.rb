  ...
  class AddressTranslator < Translator
    ...
    def translation
      [
        ...
        [:street_end_from, :streetEndFrom, :integer],
        [:street_end_to, :streetEndTo, :integer],
        [:street_name, :streetName, :string],
        [:street_prefix, :streetPrefix, :string],
        [:street_start, :streetStart, :integer],
        [:street_start_from, :streetStartFrom, :integer],
        [:street_start_to, :streetStartTo, :integer],
